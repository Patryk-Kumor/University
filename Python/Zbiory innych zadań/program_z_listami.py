...
def sumaParzystych(L):        #POPRAWIONE - OK
...
def histogram(L):
   ...
   for liczba in L:
      ...
      print ( zeSpacjami(liczba,3) + "*" * liczba )      #POPRAWIONE - OK
...
def normalizuj(L):
   ...
   srednia = suma1(L)/len(L)                             #POPRAWIONE - OK
   for i in range(len(L)):
      L[i]-=srednia
...
def madrzejsza(L):          #POPRAWIONE - OK
